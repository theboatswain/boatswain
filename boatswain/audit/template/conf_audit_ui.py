from PyQt5.QtWidgets import QWidget, QSizePolicy, QVBoxLayout, QHBoxLayout, QLabel, QPushButton
...
class ConfAuditUi(QWidget):
    ...
    def __init__(self, parent, handler) -> None:
        ...
        self.undo.setStyleSheet("border: 1px solid #999999; padding: %s; border-radius: 2px" % padding)
